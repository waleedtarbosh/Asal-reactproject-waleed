...
function ClassRoomTable() {
  ...
  const [data,setData,loading, err] =useApi('https://api.github.com/users/prabhuignoto/repos')
  const columns = [
  ...
  return (
    <div className="table">
        {loading && <p>Loading...</p>}
        <h2> There are {data.length} ClassRoom in the Database</h2>
